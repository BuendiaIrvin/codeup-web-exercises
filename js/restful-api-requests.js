...
const getBooks = () => {
    fetch("https://trail-fierce-glitter.glitch.me/books")
        .then(resp => resp.json())
        .then(books => {
            console.log(books);
            let htmlStr = "";
...
fetch("https://trail-fierce-glitter.glitch.me/books/1")
    .then(resp => resp.json())
        ...
        .then(books => {
            for (let book of books) {
                if(book.title !== newBook.title || book.author.firstName !== newBook.author.firstName || book.author.lastName !== newBook.author.lastName) {
                    fetch("https://trail-fierce-glitter.glitch.me/books", postOptions)
                        .then(getBooks);
                } else {
...
fetch("https://trail-fierce-glitter.glitch.me/books/6", putOptions).then(getBooks);
...
fetch("https://trail-fierce-glitter.glitch.me/books/7", patchOptions).then(getBooks);
...
$("#uniqueBooks").click(() => {
    ...
    fetch(`https://trail-fierce-glitter.glitch.me/books/${inputVal}`, deleteOptions)
        .then(getBooks);
})