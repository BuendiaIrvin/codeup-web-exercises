 ...
 */
var percChosen = parseFloat(prompt("What is the percentage you would like to tip?"));
var totalBill = parseFloat(prompt("What is the total bill?"));
var decimal = percChosen / 100;
var grandTotal = decimal * totalBill;
alert ("Your tip should be $" + grandTotal.toFixed(2));
/**
 * TODO:
